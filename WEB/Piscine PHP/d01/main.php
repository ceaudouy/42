...
$tab[6] = 'ssap.php';
$tab[7] = 'rostring.php';
$tab[8] = 'ft_is_sort.php';
$tab[9] = 'ssap2.php';
$tab[10] = 'do_op.php';
$tab[11] = 'do_op_2.php';
$tab[12] = 'search_it!.php';
$tab[13] = 'sing_it!.php';
$tab[14] = 'agent_stats.php';
...
echo "test 11 : ";
$req = shell_exec('./ex10/do_op.php 15 - -2');
if ($req == "17\n") {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
echo "test 11 : ";
$req = shell_exec('./ex11/do_op_2.php "15 + -4"');
if ($req == "11\n") {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
echo "test 15 : ";
$req = shell_exec('./ex11/do_op_2.php "-2516-456"');
if ($req == "-2972\n") {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
